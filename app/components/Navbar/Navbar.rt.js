...
export default function () {
    return React.createElement(Navbar, { 'fixedTop': true }, React.createElement(Navbar.Header, {}, React.createElement(Navbar.Brand, {}, React.createElement('a', { 'href': '#' }, 'React-Bootstrap')), React.createElement(Navbar.Toggle, {})), React.createElement(Navbar.Collapse, {}, React.createElement(Nav, {}, React.createElement(LinkContainer, { 'to': { pathname: '/' } }, React.createElement(NavItem, {
        'eventKey': 1,
        'href': '#'
